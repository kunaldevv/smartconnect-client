  ...
  return (
    <div className='p-3 bg-[#222529] text-white rounded-md text-xs'>
      ...
      <div className='grid grid-cols-[1.3fr_1.4fr_1.4fr_1fr] gap-10 w-full'>
        <div className=''>
          <input autoComplete="off" value={creatorData.title} onChange={(e)=>setCreatorData({...creatorData,title : e.target.value})} type="text" className='w-full rounded-md p-[6px] px-2 bg-[#32353a]' placeholder='Enter Title' />
        </div>
        <div className=''>
          <input autoComplete="off" value={creatorData.date} onChange={(e)=>setCreatorData({...creatorData,date : e.target.value})} type="date" className='w-full rounded-md p-[6px] px-2 text-slate-300 bg-[#32353a]' />
        </div>
        <div className=''>
          <input autoComplete="off" value={creatorData.time} type="time" onChange={(e)=>setCreatorData({...creatorData, time : e.target.value})} className='w-full rounded-md p-[6px] px-2 text-slate-300 bg-[#32353a]' />
        </div>
