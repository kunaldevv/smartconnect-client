...
const Header = ({profile}) => {
  ...
  <div className="flex pt-8 items-center justify-between">
    ...
    page!=='profile'&&
      ...
      <input autoComplete="off" type="text" className='outline-none dark:bg-darkElevation-300 dark:placeholder:text-darkElevation-900 text-sm border-none shadow-md w-[300px] h-[37px] rounded-md  p-2' placeholder='Search Appointments' />
